export const translations = {
  tr: {
    ...
    "mobile.locked.desc": "Android ve iOS araçları online üyelik gerektirir.",
    "mobile.locked.heading": "Online profil gerekli",
    "mobile.locked.body": "Bu bölüm yalnızca amele.noirlang.tr hesabı bağlanmış üyeler tarafından kullanılabilir.",
    "mobile.locked.toast": "Android/iOS araçları için önce online profil bağlayın.",
  ...
  en: {
    ...
    "mobile.locked.desc": "Android and iOS tools require online membership.",
    "mobile.locked.heading": "Online profile required",
    "mobile.locked.body": "This section is available only for members with a connected amele.noirlang.tr account.",
    "mobile.locked.toast": "Connect an online profile before using Android/iOS tools.",
